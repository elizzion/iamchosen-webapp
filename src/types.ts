export type UserRole =
  ...
  | 'TECHNOLOGY_TREASURY_OPERATOR'
  | 'TREASURY_AUDITOR';

export type AccountType = 'Customer' | 'Smart Customer' | 'Affiliate' | 'System' | 'Admin';
...
export interface UserProfile {
  ...
  packageLevel: 'Bronze' | 'Silver' | 'Gold' | 'Platinum' | 'Diamond' | 'City Distributor' | 'Regional Distributor' | 'None';
...
export interface CCSettings {
  ...
  transferFeeAmountType?: string;
  transferFeeAmountCC?: number;
  transferFeePayer?: string;
  transferFeeApplyOnlyOnCompleted?: boolean;
  transferFeeDestinationTreasuryId?: string;
  transferFeePublicDisplayName?: string;
  transferFeeInternalDisplayName?: string;
  transferFeeIsCommissionSource?: boolean;
  transferFeeCountsTowardBusinessCycle?: boolean;
}
