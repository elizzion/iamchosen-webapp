      ...
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <motion.button
            ...
            onClick={onLogout}
            title="Logout"
            className="p-2 bg-[#17181D]/80 hover:bg-red-950/20 hover:text-red-400 border border-zinc-800/80 hover:border-red-500/20 rounded-xl text-zinc-400 transition-colors cursor-pointer"
          >
