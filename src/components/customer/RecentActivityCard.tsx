  ...
  return (
    <div className="bg-[#1D1F26] border border-zinc-800 rounded-3xl p-5 sm:p-6 space-y-5">
      ...
      <div className="flex flex-col gap-3">
        ...
        {/* Filter pills - placed cleanly on the next line to prevent any card layout overflow */}
        <div className="flex items-center gap-1.5 p-1 bg-zinc-950 border border-zinc-900 rounded-xl self-start">
          <button
