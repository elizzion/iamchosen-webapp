...
export default function MyDigitalWallet({
  ...
  const [cashinChannel, setCashinChannel] = useState<
    'GCash' | 'Maya' | 'BDO' | 'GOTymeBank' | 'BPI'
  >('GCash')
        ...
        {!hasPendingCashInRequest && (
          <form onSubmit={handleCashinSubmit} className='space-y-4'>
            ...
            <div>
              ...
              >
                <option value='GCash'>GCash (0947-5047-299)</option>
                <option value='Maya'>Maya (0947-5047-299)</option>
                <option value='BDO'>BDO (006930170398)</option>
                <option value='BPI'>BPI (4229-2502-19)</option>
                <option value='GOTymeBank'>GOTymeBank (014495829050)</option>
              </select>
            </div>
