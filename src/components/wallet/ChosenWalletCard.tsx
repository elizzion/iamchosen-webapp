...
export default function ChosenWalletCard({
  ...
  if (error) {
    return (
      ...
      >
        <div className="py-4">
          <p className="text-zinc-400 text-sm mb-3">We could not load your Chosen Wallet. Please refresh and try again.</p>
      ...
      <div className="relative z-30">
        ...
        <div className="mb-2 pr-[130px] sm:pr-[160px] md:pr-[200px]">
          <div className="mb-2 flex items-center gap-2">
            <span id="chosen-wallet-heading" className="text-[11px] font-semibold text-zinc-400 uppercase tracking-widest font-sans">
            ...
            <button
              ...
              aria-label={showBalance ? "Hide Chosen Wallet balance" : "Show Chosen Wallet balance"}
            >
          ...
          <div className="text-3xl sm:text-4xl font-black leading-none text-cyan-400 font-sans tracking-tight flex items-baseline gap-1.5">
            ...
            <span className="text-xs sm:text-sm font-extrabold text-zinc-500">CC</span>
          </div>
