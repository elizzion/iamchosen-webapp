...
import SponsorCard from './customer/SponsorCard';
...
import ChosenOptionsSection from './customer/ChosenOptionsSection';
...
export default function CustomerDashboard({ userProfile, onLogout, onNavigate }: CustomerDashboardProps) {
  ...
  const notifications = [
    { id: 1, title: 'Welcome to I AM CHOSEN', desc: 'Your customer profile is secured. Start purchasing premium wellness products now.', date: 'Just now', unread: true },
    { id: 2, title: 'KYC Verification Status', desc: 'Your identity profile is verified by corporate compliance.', date: '2 hours ago', unread: false },
    { id: 3, title: 'Cash-In Request Update', desc: 'Standard Cash-In requests usually process in 1-2 hours.', date: '1 day ago', unread: false },
    { id: 4, title: 'Product Recommendation', desc: 'Try our top-selling Chosen 15-in-1 Latte Coffee for clear daily energy.', date: '2 days ago', unread: false }
  ];
  ...
  return (
    <div className="bg-[#0B0B0F] text-zinc-100 min-h-screen font-sans selection:bg-gold selection:text-[#0B0B0F] relative overflow-x-hidden pb-24 lg:pb-8">
      ...
      <div className="lg:pl-64 min-h-screen flex flex-col justify-between">
        <main className="flex-1 max-w-4xl w-full mx-auto p-4 sm:p-6 lg:p-8 space-y-6 pb-[100px] lg:pb-8">
              ...
              {activeMobileTab === 'home' && (
                ...
                <div className="flex justify-between items-start gap-3 mb-5">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <h1 className="text-2xl font-black text-[#D4AF37] leading-tight truncate">
                      {firstName}! 👋
                    </h1>

                    <p className="text-zinc-500 text-xs mt-1">
                      Enjoy premium Chosen products.
                    </p>
                  ...
                  >
                    ...
                    <div className="w-9 h-9 rounded-xl bg-[#2A1F08] flex items-center justify-center">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                    {/* Main Contents (Balance, Quick Actions, Banners, Products) */}
                    <div className="lg:col-span-2 space-y-6">
                      {/* CHOSEN WALLET BALANCE CARD */}
                      <div className="relative overflow-hidden rounded-2xl border border-cyan-500/20 bg-gradient-to-br from-[#111318] via-[#10151B] to-[#07090D] p-5 shadow-[0_0_30px_rgba(0,229,210,0.08)]">
                        {/* Glow */}
                        ...
                        <div className="relative z-30">
                          ...
                          <div className="mb-2 pr-[140px]">
                            ...
                            {/* Balance */}
                            <div className="text-3xl sm:text-4xl font-black leading-none text-cyan-400 font-mono tracking-tight">
                              {showBalance ? (wallet?.chosenWalletBalance?.toFixed(2) || "0.00") : "••••••"}{" "}
                              <span className="text-xs sm:text-sm font-extrabold text-zinc-500 font-sans">CC</span>
                            </div>

                            <div className="mt-2 text-xs sm:text-sm text-zinc-400 font-mono">
                              ≈ ₱{showBalance ? ((wallet?.chosenWalletBalance || 0) * ccSettings.cashOutRatePHP).toLocaleString("en-PH", {
                          ...
                          <div className="mt-5 grid grid-cols-3 gap-3">
                            <button
                              onClick={() => setActiveMobileTab("cashin")}
                              className="flex flex-col items-center justify-center gap-1.5 rounded-xl bg-gradient-to-br from-cyan-400 to-teal-600 px-2 py-3 text-white shadow-[0_4px_12px_rgba(0,229,210,0.25)] hover:shadow-[0_6px_20px_rgba(0,229,210,0.4)] hover:scale-[1.02] active:scale-95 transition-all cursor-pointer"
                            >
                            ...
                            <button
                              onClick={() => setActiveMobileTab("cashout")}
                              className="flex flex-col items-center justify-center gap-1.5 rounded-xl bg-gradient-to-br from-purple-500 to-violet-800 px-2 py-3 text-white shadow-[0_4px_12px_rgba(168,85,247,0.25)] hover:shadow-[0_6px_20px_rgba(168,85,247,0.4)] hover:scale-[1.02] active:scale-95 transition-all cursor-pointer"
                            >
                              <Upload className="h-5 w-5" />
                              <span className="text-[11px] font-bold">Cash-Out</span>
                            </button>

                            <button
                              onClick={() => setActiveMobileTab("transfer")}
                              className="flex flex-col items-center justify-center gap-1.5 rounded-xl bg-gradient-to-br from-blue-500 to-blue-800 px-2 py-3 text-white shadow-[0_4px_12px_rgba(59,130,246,0.25)] hover:shadow-[0_6px_20px_rgba(59,130,246,0.4)] hover:scale-[1.02] active:scale-95 transition-all cursor-pointer"
                            >
                      ...
                      {/* YOUR CHOSEN OPTIONS SECTION */}
                      <ChosenOptionsSection 
                        onNavigate={onNavigate} 
                        role={userProfile.role} 
                      />

                      {/* PRODUCTS CATALOG SECTION */}
                      <div id="shop-catalog" className="space-y-4 pt-2">
                        <SectionTitle
                          title="Wellness Products Catalog"
                          subtitle="Exchange Chosen Credits (CC) directly for premium items"
                    ...
                    <div className="space-y-6">
                      {/* SPONSOR CARD */}
                      <SponsorCard sponsor={sponsor} loading={sponsorLoading} />
                    ...
                    {notifications.map((notif) => (
                      <div
                        ...
                        className={`p-4 rounded-2xl border transition-all duration-300 ${
                          notif.unread
                            ? 'bg-[#17181D] border-cyan-500/30 shadow-[0_0_15px_rgba(6,182,212,0.05)]'
